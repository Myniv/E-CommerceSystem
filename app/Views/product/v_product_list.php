...
<div class="container mt-4">
    ...
    <a href="<?= base_url("api/product/create") ?>" class="btn btn-success mb-3">Tambah Produk</a>
                ...
                <?php foreach ($products as $product) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/api/product/edit/<?= $product->getId(); ?>" class="btn btn-warning btn-sm">Edit</a>
                            <form action="/api/product/delete/<?= $product->getId(); ?>" method="post" class="d-inline">
